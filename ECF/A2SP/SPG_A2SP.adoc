...
|            1 jours  | Examen blanc                          | Aucun | QCM, exercices pratiques | Salle de formation équipée, matériel de sécurité | QCM, exercices pratiques | Problèmes de stress : prévoir un accompagnement individualisé
|==========================================================
.**Durée de la formation : 210h**
