= Scénario pédagogique global (SPG) : A2SP - AGENT(E) DE SÛRETÉ ET DE SÉCURITÉ PRIVÉE
...
* Évacuer le public en cas d'incendie.
...
|==========================================================
| Séquences | durée
| *Basiques de communication* | 2,5 jours
| *Anglais* | 2 jours
| *Inclusion numérique & cybersécurité* | 1 jour
| *Inclusion sociétale & lutte contre les discriminations*| 1/2 jour
| *Agent De Sureté (ADS)* | 9 jours
| *Examen PIX* | 1/2 jours
| *Technique de recherche d'emploi (TRE)* | 2,5 jours
| *Habilitation électrique (H0B0)* | 2 jours
| *Sauveteur Secouriste du Travail (SST)* | 2 jours
| *Stage sureté* | 5 jours
| *SSIAP 1* | 14 jours
| *Stage sécu incendie*| 5 jours
| *Examen blanc A2SP* | 1 jour
| _**Durée totale**_| 47 jours
|==========================================================

.**Durée totale de la formation : 329h**
(70h en stage)
...
- Plateau technique dédié qui reconstitue les conditions de réalisation des gestes professionnels ; conforme aux RC (Référentiels de Compétences) du TP (Titre Professionnel) et CQP (Certificat de Qualification Professionnelle)
...
| *Basiques de communication* |  Exercices, jeux de rôle | Salle de formation équipée, vidéoprojecteur, ordinateurs | QCM, exercices pratiques| 2,5 jours
...
| *Inclusion numérique & cybersécurité* | Resources en ligne|Salle de formation équipée d'ordinateur et accès internet|QCM, exercices pratiques| 1 jour
| *Inclusion sociétale & lutte contre les discriminations*| Exercices, jeux de rôle | Salle de formation équipée, vidéoprojecteur, ordinateurs  |QCM, exercices pratiques| 1/2 jour
...
| *Examen PIX*|||| 1/2 jours
| *Technique de recherche d'emploi (TRE)* | Ateliers, simulations | Salle de formation équipée, ordinateurs | Simulation d'entretien d'embauche| 2,5 jours
...
| | | | **Duréé total**| 47 jours
|==========================================================
.**Durée totale de la formation : 329 h**
(70h en stage)
...
.Evaluation pour le passage de titre
- **Questionnaire professionnel** : Cette épreuve écrite collective dure 45 minutes et permet d'évaluer les connaissances des stagiaires sur les compétences requises pour l'exercice des activités composant le titre visé ⁶.
- **Mise en situation professionnelle** : Cette épreuve individuelle dure 1 heure 30 minutes et est suivie d'un entretien technique de 15 minutes. Elle permet d'évaluer la capacité des stagiaires à mobiliser les compétences acquises pour résoudre une situation professionnelle ⁶.
- **Entretien final devant le jury** : Cette épreuve individuelle dure 10 minutes et permet de vérifier le niveau de maîtrise par le candidat des compétences requises pour l'exercice des activités composant le titre visé ⁶.
...
// TODO: Ajoutez une section sur les modalités d'accès à la certification. Cela peut inclure des informations sur les conditions d'admission à l'examen, ainsi que sur les modalités de réinscription.
...
[[price]]
== 14. Tarifs et modalités de financement
4704€ HT
les modalités de financement de la formation : Cela peut être utile pour les apprenants potentiels qui souhaitent connaître les options qui s'offrent à eux.
...
L'accessibilité et l'égalité devant l'emploi sont des sujets que nous favorisons, en préparant l'accès en formation aux apprenants avec handicaps. Nous étudions individuellement avec notre référant les possibilités d'inclusion et d'insertion dans le domain professionnel de la sécurité et sureté. +
Notre référant handicap est à votre disposition pour toutes demandes sur l'accessibilité et l'employabilité des personnes en handicap.
...
Apres la formation, nous recueillons les avis et impressions des apprenants sur la formation, dans un souci d'amélioration continue, transparence avec l'organisme financeur et suivie d'activité professionnelle de l'apprenant.
